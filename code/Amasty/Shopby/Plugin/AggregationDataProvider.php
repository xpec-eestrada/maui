...
class AggregationDataProvider
{
    ...
    public function aroundGetDataSet(
        ...
        if ($bucket->getField() == 'stock_status') {
            $isStockEnabled = $this->scopeConfig->isSetFlag('amshopby/stock_filter/enabled',
        ...
        if ($bucket->getField() == 'rating_summary') {
            $isRatingEnabled = $this->scopeConfig->isSetFlag('amshopby/rating_filter/enabled',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            if ($isRatingEnabled) {
        ...
        if ($bucket->getField() == 'is_new') {
            $isNewEnabled = $this->scopeConfig->isSetFlag('amshopby/is_new_filter/enabled',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            if ($isNewEnabled) {
        ...
        if ($bucket->getField() == 'on_sale') {
            $isOnSaleEnabled = $this->scopeConfig->isSetFlag('amshopby/on_sale_filter/enabled',
                \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
            if ($isOnSaleEnabled) {
