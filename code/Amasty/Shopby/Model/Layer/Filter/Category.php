...
class Category extends \Magento\Catalog\Model\Layer\Filter\AbstractFilter
{
    ...
    protected function getExtendedCategoryData()
    {
        ...
        $isRenderAllCategoriesTree = $setting->getRenderAllCategoriesTree() || $isRootCategory || $isChildrenLevel;
    ...
    protected function getFacetedData()
    {
        ...
        if ($this->hasCurrentValue() ||
            ...
            $requestBuilder->removePlaceholder(CategoryHelper::STORE_CODE);
            /* add current category to filter, because it's must be */
            $requestBuilder->bind(CategoryHelper::STORE_CODE, $this->getStoreId());
