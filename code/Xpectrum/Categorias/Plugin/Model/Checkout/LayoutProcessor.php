 ...
 */
namespace Xpectrum\Categorias\Plugin\Model\Checkout;
...
class LayoutProcessor implements \Magento\Checkout\Block\Checkout\LayoutProcessorInterface
{
    ...
    public function process($jsLayout)
    {
        ...
        $ar = $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']
        ['children']['shippingAddress']['children']['shipping-address-fieldset']['children'];
        ...
        if($customerSession->isLoggedIn()) {
            ...
            if(isset($ar['fecha_de_nacimiento'])){
                unset($ar['fecha_de_nacimiento']);
            }
        }
        $jsLayout['components']['checkout']['children']['steps']['children']['shipping-step']
        ['children']['shippingAddress']['children']['shipping-address-fieldset']['children'] = $ar;
        return $jsLayout;
    }
